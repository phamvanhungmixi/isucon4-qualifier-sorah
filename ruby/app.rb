  ...
  class App
    ...
    module Actions
      ...
      def action_mypage
        ...
        @body = MYPAGE_TEMPLATE.dup
        @body[1] =  Time.at(last_login['at'].to_i).strftime("%Y-%m-%d %H:%M:%S")
        @body[3] = last_login['ip']
        @body[5] = current_user['login']
      end
